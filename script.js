...
const slogans = [ "Chaque expérience est unique.", "Grandissons ensemble.", "Votre potentiel, notre mission.", "L’excellence commence par l’humain.", "La compétence au cœur de la performance.", "Construisons l’avenir ensemble.", "Apprendre, évoluer, réussir.", "La qualité est notre engagement.", "Votre savoir-faire fait la différence.", "Ensemble vers l’excellence.",
"Vos compétences, notre fierté.", "Compétences d’aujourd’hui, succès de demain.", "Développer les compétences, libérer les performances.", "Chaque compétence compte, chaque personne brille.", "Cultivons les compétences, récoltons l’excellence.", "Rendre visible chaque compétence.", "Vos compétences prennent vie ici.",
, "Votre talent mérite d’être vu.", "Mettre en lumière vos talents." ]; let sloganIndex = 0; const sloganElement = document.getElementById("sloganText"); 

if (sloganElement) { setInterval(() => { sloganIndex = (sloganIndex + 1) % slogans.length; sloganElement.textContent = slogans[sloganIndex]; }, 3000); }
